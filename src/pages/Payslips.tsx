    ...
    <div className="space-y-5 animate-fade-in">
                  ...
                  <TableRow key={r.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        <Button size="icon" variant="ghost" className="h-7 w-7" onClick={() => setViewRecord(r)} title="View">
                          <Eye className="h-3.5 w-3.5" />
                        </Button>
                        <Button size="icon" variant="ghost" className="h-7 w-7" onClick={() => openEdit(r)} title="Edit">
                          <Pencil className="h-3.5 w-3.5" />
                        </Button>
                        <Button size="icon" variant="ghost" className="h-7 w-7 text-destructive" onClick={() => setDeleteId(r.id)} title="Delete">
      ...
      <Dialog open={!!editRecord} onOpenChange={(open) => !open && setEditRecord(null)}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle className="font-extrabold">Edit Payslip</DialogTitle>
          </DialogHeader>
          {editRecord && (
            <div className="space-y-3">
              ...
              <Separator />
              <p className="text-xs font-bold text-foreground uppercase tracking-wider">Deductions</p>
